...
Before shaping an Assignment, read relevant active notes directly under
.specdev/project_notes/architecture/ and exclude legacy/ from authority.
Ordinary Brainstorms do not publish protected notes. For an explicit note
request or detected conflict, read .specdev/_guides/architecture_guide.md and
follow its exact-draft approval and architecture-only checkpoint rules.
