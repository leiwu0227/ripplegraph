...
.specdev/
  ...
  project_notes/architecture/          active, protected project authority
  project_notes/architecture/legacy/   superseded architecture history
  knowledge/codebase/                  revisable implementation facts
  knowledge/faq/                       current, freshness-aware troubleshooting
  knowledge-curations/KC-<hash>.json   verified publication receipts
  publications/P<id>.json             lane-independent shared-note publication receipts
...
specdev publish --proposal=<path> | --from-curation=<KC-id> | --approve=<sha256> | --status
